...
export const DIAGNOSTIC_EVENT_NAMES = [
  ...
  "tree_visibility_unhealthy",
  "tree_visibility_recovered",
  "tree_manual_view_reset",
  "tree_swap_started",
  "tree_pending_ready",
  "tree_swap_committed",
  "tree_swap_failed",
  "tree_swap_kept_previous",
  "tree_manual_reset_started",
  "tree_manual_reset_ignored_duplicate",
  "tree_manual_reset_completed",
