...
export default function Terms() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4" style={{ background: "var(--ds-bg)" }}>
      ...
      {/* カード */}
      <div
        className="w-full max-w-[560px] bg-white rounded-[14px] overflow-hidden"
        ...
        <div className="px-8 py-5 border-b" style={{ borderColor: "var(--ds-border)" }}>
          <div className="flex items-center gap-0">
            ...
            <div className="flex items-center gap-2">
              <div className="w-[22px] h-[22px] rounded-full flex items-center justify-center" style={{ background: "var(--brand)" }}>
            ...
            {/* Step 3: 未来 */}
            <div className="flex items-center gap-2">
              <div className="w-[22px] h-[22px] rounded-full flex items-center justify-center" style={{ background: "var(--ds-border)" }}>
        ...
        <div className="px-8 py-6 space-y-4">
          ...
          <div className="flex gap-3">
            ...
            <div className="flex-1">
              <DsButton fullWidth type="button" onClick={() => navigate("/")}>
                同意してはじめる
              </DsButton>
            </div>
          </div>
